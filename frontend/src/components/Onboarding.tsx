...
export function Onboarding({ onComplete }: OnboardingProps) {
  useEffect(() => {
    // Breve tiempo de exposición para el mensaje de bienvenida corporativa
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-bg-main text-white overflow-hidden relative">
      ...
      >
        ...
        <h2 className="text-5xl font-black tracking-tighter italic italic">
