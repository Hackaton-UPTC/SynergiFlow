...
import { AbsurdMetric, Activity, PopupMessage } from '../types/dashboard';
...
export const useDashboardData = () => {
  ...
  const [activities] = useState<Activity[]>([
    { id: '1', title: 'Alineación de Paradigma', description: 'Se ha forzado una nueva visión sobre el equipo de diseño.', time: 'Hace 2 min' },
    { id: '2', title: 'Evento de Sinergia Crítica', description: 'Niveles de café por debajo del umbral corporativo.', time: 'Hace 15 min' },
    { id: '3', title: 'Actualización de Vaporware', description: 'El módulo "Felicidad del Cliente" ha sido renombrado a "Métrica de Retención".', time: 'Hace 1 hora' },
    { id: '4', title: 'Fuga de Optimismo', description: 'Se detectó un empleado sonriendo sin autorización previa.', time: 'Hace 3 horas' },
  ]);
